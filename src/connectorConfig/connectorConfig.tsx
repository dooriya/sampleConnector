...
/**
 * Implementation of the connector configuration page
 */
        ...
        if (context) {
            microsoftTeams.settings.registerOnSaveHandler((saveEvent: microsoftTeams.settings.SaveEvent) => {
                ...
                const settings: any = {
                    ...
                    contentUrl: `https://${process.env.PUBLIC_HOSTNAME}/config.html?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}`,
